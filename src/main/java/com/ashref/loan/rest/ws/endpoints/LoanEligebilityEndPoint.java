...
import com.ashref.loan.rest.ws.services.LoanEligebilityService;
...
public class LoanEligebilityEndPoint {
	@Autowired
	private LoanEligebilityService service;
	...
	public ResponseEntity<WsResponse> getLoanStatus(@RequestBody CustomerRequest customerRequest) {
		return new ResponseEntity<WsResponse>(service.checkLoanEligebility(customerRequest), HttpStatus.OK);
	}
}
